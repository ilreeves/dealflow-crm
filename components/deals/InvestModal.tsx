...
export default function InvestModal({ deal, actorName, onCancel, onDone }: Props) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/40 p-4 max-md:p-0">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-xl max-h-[92vh] flex flex-col max-md:max-w-none max-md:h-dvh max-md:max-h-none max-md:rounded-none">
        <div className="px-6 max-md:px-4 py-4 border-b border-slate-100 flex items-start justify-between gap-3 shrink-0">
          <div>
        ...
        <div className="flex-1 overflow-y-auto px-6 max-md:px-4 py-4 space-y-3">
