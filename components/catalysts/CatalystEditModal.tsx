...
export default function CatalystEditModal({ catalyst, onClose, onSaved, onDeleted }: Props) {
  ...
  return (
    // Full-screen sheet on phones (max-md) with a scrolling body; md+ unchanged.
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/40 p-4 max-md:p-0" onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()} className="bg-white rounded-2xl shadow-xl w-full max-w-md max-md:flex max-md:flex-col max-md:max-w-none max-md:h-dvh max-md:max-h-none max-md:rounded-none">
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 max-md:shrink-0">
        ...
        <div className="px-5 py-4 space-y-3 max-md:flex-1 max-md:overflow-y-auto">
          <div>
        ...
        <div className="flex items-center gap-2 px-5 py-4 border-t border-slate-100 max-md:shrink-0">
